...
static builder::dyn_var<void(timer_t*, void*, unsigned long long)> redelivery_timer_callback = builder::as_global("nbp__reliable_redelivery_timer_cb");
...
void reliable_module::gen_timer_callback(std::ostream &oss) {	
	auto ast = builder::builder_context().extract_function_ast(redelivery_cb, "nbp__reliable_redelivery_timer_cb");
