...
const char data_queue_t_name[] = "nbp__data_queue_t";
const char accept_queue_t_name[] = "nbp__accept_queue_t";
#define MAX_ACTIVE_CONNECTIONS (512)
namespace runtime {
builder::dyn_var<char[HOST_IDENTIFIER_LEN]> wildcard_host_identifier = builder::as_global("nbp__wildcard_host_identifier");
}
